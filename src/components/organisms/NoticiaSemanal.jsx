...
function NoticiaSemanal() {
    return (
        ...
        <Noticia imagen="./public/nintendo.jpg" titulo="Nintendo anuncia la compra del estudio Shiver Entertainment" texto="El fabricante japonés y desarrollador de consolas y videojuegos Nintendo llegó a un acuerdo con el grupo sueco Embracer para adquirir el 100% de las acciones en circulación de Shiver Entertainment. La transacción, se completará una vez cumplidas las condiciones de cierre habituales y tendrá sólo un efecto menor en los resultados de Nintendo para el año fiscal en curso."></Noticia>
